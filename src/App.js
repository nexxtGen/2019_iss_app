      ...
      if (this.state.currentIssData.timestamp !== "") {
        ...
        if (this.state.distanceBetween) {
          this.calculateVelocity(
            this.state.distanceBetween,
            initialIssData.timestamp,
            currentIssData.timestamp
          );
          this.calculateTime(
            initialIssData.timestamp,
            currentIssData.timestamp
        ...
        <div className="navbar">
          <div className="navbar-container">
            <div className="navbar-container-git">
              <a
                href="https://github.com/nexxtGen/2019_iss_app"
                target="_blank"
        ...
        <div className="app-container">
          <div className="data-container">
            <div className="data-box-1">
              <DataContainerOne resetTracking={this.resetTracking} />
            </div>
